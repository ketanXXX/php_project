        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="electronicbooking.">Phone</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="electronicbooking.">Electronic Items</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="electronicbooking.">AC Sale and Service</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <li><a class="dropdown-item" href="ecr.">ECR</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="pondi.">Pondicherry</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="wayanadu.">Wayanad</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="munnar.">Munnar</a></li>
                    <li><hr class="dropdown-divider"></li>
                    <li><a class="dropdown-item" href="varkala.">Varkala</a></li>
                  </ul>
              </li>
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle text-dark" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="container text-center text-md-start mt-5">
      ...
      <div class="row mt-3">
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="ecr." class="text-reset">ECR</a>
          </p>
          <p>
            <a href="kodaikanal." class="text-reset">Kodaikanal</a>
          </p>
          <p>
            <a href="pondi." class="text-reset">Pondicherry</a>
          </p>
        ...
        <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4">
          ...
          <p>
            <a href="munnar." class="text-reset">Munnar</a>
          </p>
          <p>
            <a href="varkala." class="text-reset">Varkala</a>
          </p>
          <p>
            <a href="wayanadu." class="text-reset">Wayanadu</a>
          </p>
        </div>
        <!-- Grid column -->
