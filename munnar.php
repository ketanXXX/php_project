...
<head>
    ...
    <title><Pondi-Resorts></Pondi-Resorts></title>
...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    ...
    <section class="caption">
        <h1>Unwind in Nature's Embrace: Your Tranquil Retreat in Munnar Awaits!</h1>
    </section>
    <section class="container">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="./munnar/munnar-1.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./munnar/munnar-2.jpeg" class="d-block w-100" alt="...">
              </div>
            </div>
    ...
    <!----><div class="content-block s-separator description s-description" ng-if="translations.room[room.roomId].desc || room.longDesc">
      ...
      <span class="strans">Finding an affordable homestay in Munnar that ticks all the boxes could get daunting. Well, if you’re looking 
        for a perfect getaway, your search ends with our quaint little kabin right here. A couple of hours drive away from Munnar Station is all it 
        takes to reach our minimalistic yet luxurious homestay overlooking the Pawna valley. This massive kabin spread across a hill comes with 2 fully
         air conditioned bedrooms and a living room, a private infinity plunge pool, and a private garden. Breakfast and driver’s
         accommodation shall be covered with no additional cost. Our in-house menu lets you enjoy a wide range of delicacies. All you need to do is pick 
         a dish, and leave it to our caretakers to treat you to some homely delicious food while you sit back and breathe in nature's beauty. For 
         some it’s a getaway to relax and reboot. For some to celebrate love, for some to just simply celebrate themselves and nature.</span></p>
    </div><!---->
