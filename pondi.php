...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="index.php8">
    ...
    <section class="caption">
        <h1>Pondicherry Paradise: Where Serenity Meets Luxury</h1>
    </section>
    <section class="container">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="./pondi/pondi-1.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./pondi/pondi-2.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./pondi/pondi-3.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./pondi/pondi-4.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./pondi/pondi-5.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./pondi/pondi-6.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./pondi/pondi-7.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./pondi/pondi-8.jpeg" class="d-block w-100" alt="...">
              </div>
            </div>
