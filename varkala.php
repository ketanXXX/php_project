...
<body>
  <nav class="navbar navbar-expand-lg navbar-light bg-light sticky-top">
        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item dropdown">
                ...
                <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                  <li><a class="dropdown-item" href="electronicbooking.php">Phone</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="electronicbooking.php">Electronic Items</a></li>
                  <li><hr class="dropdown-divider"></li>
                  <li><a class="dropdown-item" href="electronicbooking.php">AC Sale and Service</a></li>
                </ul>
              </li>
              <li class="nav-item dropdown">
    ...
    <section class="caption">
        <h1>Varkala Bliss: Where Serenity Meets Luxury at Our Beachfront Resort!</h1>
    </section>
    <section class="container">
        <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
            <div class="carousel-inner">
              <div class="carousel-item active">
                <img src="./varkala/varkala-2.jpeg" class="d-block w-100" alt="...">
              </div>
              <div class="carousel-item">
                <img src="./varkala/varkala-1.jpeg" class="d-block w-100" alt="...">
              </div>
            </div>
